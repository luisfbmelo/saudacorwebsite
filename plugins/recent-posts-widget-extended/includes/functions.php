			...
			$html .= '<ul class="rpwe-ul">';
				...
				while ( $posts->have_posts() ) : $posts->the_post();
					...
					$html .= '<li class="rpwe-li rpwe-clearfix">';
						...
						$html .= '<div class="rpwe-title"><a href="' . esc_url( get_permalink() ) . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'recent-posts-widget-extended' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark">' . esc_attr( get_the_title() ) . '</a></div>';
